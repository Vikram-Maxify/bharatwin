...
function Calendar({ onDateSelect, onValueChange }) {
 ...
 <div className={isOpen ? 'overlay-section block' : 'hidden'}></div>
      ...
      {isOpen && (
        <div className="fixed bottom-0 left-0 right-0 m-auto w-full min-w-content h-[300px] z-50 rounded-t-xl shadow-lg "
          ...
          <div className=" absolute bottom-[134px] h-10 w-full  bg-[#2A2A2A] "
          ></div>
        </div>
      )}
    </div>
