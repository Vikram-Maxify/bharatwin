...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bgs-body">
      ...
      {/* Activity Details */}
      <div className="mx-4">
        <div className="blue-linear rounded-t-lg mt-5 flex items bg-center justify-between px-6 py-3 text-black font-semibold">
          <div>Task</div>
        ...
        {/* Balance */}
        <div>
          <div className="nav-bg h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹1,000.00</p>
          ...
          <div className="bg-popup-nav h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹5,000.00</p>
              <span className="text-[15px]">Cumulative </span>
              <span className="text-[15px]"> depositsBalance</span>
            </div>
          ...
          <div className="nav-bg h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹10,000.00</p>
              <span className="text-[15px]">Cumulative </span>
              <span className="text-[15px]"> depositsBalance</span>
            </div>
          ...
          <div className="bg-popup-nav h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹50,000.00</p>
              <span className="text-[15px]">Cumulative </span>
              <span className="text-[15px]"> depositsBalance</span>
            </div>
          ...
          <div className="nav-bg h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹100,000.00</p>
              <span className="text-[15px]">Cumulative </span>
              <span className="text-[15px]"> depositsBalance</span>
            </div>
          ...
          <div className="bg-popup-nav h-[auto] flex items-center justify-between px-4 py-4 text-[#768096]  ">
            <div className="flex flex-col items-center justify-center leading-5">
              <p className="text-[16px] text-[#21D9CC] ">₹200,000.00</p>
              <span className="text-[15px]">Cumulative </span>
              <span className="text-[15px]"> depositsBalance</span>
            </div>
        ...
        {/* Rules */}
        <div className="nav-bg h-auto rounded-lg mt-10 pb-6">
          <h1 className="bg-[#21D9CC] mx-24 text-center text-white font-bold tracking-wider text-[20px] rounded">
            Rules
          </h1>
          ...
          <div className="flex items-start justify-start gap-5 px-2 pb-3">
            ...
            <h3 className="leading-5 tracking-normal text-[15px] text-gray-500 font-medium">
              ...
              <span className="text-[#21D9CC]">1</span> times turnover required.
            </h3>
          </div>
          ...
          <div className="flex items-start justify-start gap-5 px-2 py-3">
            ...
            <h3 className="leading-5 tracking-normal text-[15px] text-gray-500 font-medium">
              ...
              <span className="text-[#21D9CC]">00:00</span>. After making your
          ...
          <div className="bg-popup-nav h-auto px-3 leading-5 tracking-wider text-[15px] text-gray-500 font-medium mx-3 rounded-lg py-3 mt-2">
            ...
            <span className="text-[#21D9CC]">₹200,000.00</span>
            <span>
              {" "}
              on the same day, he or she will receive{" "}
              <span className="text-[#21D9CC]">6</span>{" "}
            </span>
            <span>
