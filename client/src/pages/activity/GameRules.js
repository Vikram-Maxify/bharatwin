          ...
          <div
            className={
              i % 2 == 0
                ...
                : "grid grid-cols-12 bg-rule p-2 py-3"
            }
            key={i}
          >
            <div className="col-span-4 flex text-center justify-center">
              <span className="text-base text-whites font-medium">{i + 1}</span>
            </div>
            <div className="col-span-4  text-center justify-center">
              <span className="text-base text-whites font-medium">
        ...
        <div className="nav-bg mt-5 px-2 pb-5">
          ...
          <ul>
            <li className=" flex">
              ...
              <p className="text-sm text-whites  leading-[18px]">
