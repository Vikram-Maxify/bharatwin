      ...
      <div className="container-section mt-2 pb-5">
        ...
        {RuleData.map((item, i) => (
          <div
            className={
              i % 2 == 0
                ? "grid grid-cols-12 bg-popup-nav p-2 py-3"
                : "grid grid-cols-12 p-2 py-3"
            }
            key={i}
          >
            <div className="col-span-4 flex text-center justify-center">
              <span className="text-sm black-2 font-medium ">
                {item.Icount}People
              </span>
            </div>
            <div className="col-span-4  text-center justify-center">
        ...
        <div className="nav-bg mt-5 px-2 pb-5">
          <div className="bg-popup-nav w-[60%] rounded-bl-full mb-2 py-1 rounded-br-full flex justify-center m-auto  font-bold text-base">
            Rules
          </div>
          <ul>
            <li className=" flex">
              ...
              <p className="text-sm black-2  leading-[18px]">
