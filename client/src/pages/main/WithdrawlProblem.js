...
import { userProblem, userProblemget } from "../../store/reducer/activityReducer";
      ...
      <div className="m-0 p-0">
        {showModal && (
          <div className="fixed inset-0  bg-opacity-50 flex justify-center items-center z-50 p-2">
            <div className="nav-bg rounded-sm w-full max-w-lg p-6 relative text-center">
          ...
          <div className=" mt-5 rounded-sm-lg w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <select
                ...
                className="text-sm nav-bg gray-50 w-full border border-color-slat rounded-sm px-3 py-2 mb-4 gray-50"
              >
              ...
              {selectedIssue && (
                <>
                  <label className="gray-50 block text-left mb-2  font-semibold">
                    * {bannergetData?.gameall?.name} Games ID:
                  </label>
                  <input
                    type="text"
                    name="gameId"
            ...
            <button
              type="button"
              className="w-full border border-color-slat nav-bg py-2 rounded-sm mb-4 gray-50"
            ...
            <button
              type="button"
              className="w-full border border-color-slat nav-bg py-2 rounded-sm gray-50"
            >
              Other Problem
            </button>
          </div>
